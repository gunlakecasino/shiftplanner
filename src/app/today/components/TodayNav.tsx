...
const navVariants = cva(
  "sb-floating-nav-pill fixed top-2 z-40 grid h-14 grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-1.5 rounded-3xl px-3 sm:px-4 transition-all duration-200",
  {
    variants: {
      glass: {
...
export type TodayNavProps = {
  ...
  onPrint?: () => void;
  isPrinting?: boolean;
  /** /logs — filter entries by operator */
  logOperators?: string[];
            ...
            <>
              ...
              {showPrint && onPrint ? (
                <NavToolButton
                  ...
                  ariaLabel="Print deployment and break sheets"
                  active={isPrinting}
              ...
              <div className="grid grid-cols-7 gap-0.5 text-center">
                {(() => {
                  ...
                  const renderDay = (d: Date, key: string, muted = false) => {
                    ...
                    const datesReady = publishedDates !== undefined;
                    const isUnpublished =
                      !isLogs && datesReady && !isPublished && !isTonight;
