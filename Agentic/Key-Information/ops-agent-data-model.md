...
| `weeks`                      | GRAVE week container (Fri–Thu, keyed by Thu) | id, week_ending (date), label, status, schedule_path, notes, created/updated_at    | getOrCreateNightForDate, sudoActions, listSchedules, BatchPlanner | High — week scoping for nights + imported ADP schedules |
